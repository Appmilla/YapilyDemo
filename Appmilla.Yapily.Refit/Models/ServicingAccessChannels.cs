namespace Appmilla.Yapily.Refit.Models
{
    ...
    public enum ServicingAccessChannels
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"MobileBankingApp")]
        MobileBankingApp = 4,

        [System.Runtime.Serialization.EnumMember(Value = @"Online")]
        Online = 5,

        [System.Runtime.Serialization.EnumMember(Value = @"PostOffice")]
        PostOffice = 6,

        [System.Runtime.Serialization.EnumMember(Value = @"RelationshipManager")]
        RelationshipManager = 7,
