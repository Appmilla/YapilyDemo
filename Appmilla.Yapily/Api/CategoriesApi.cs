...
namespace Appmilla.Yapily.Api
{
    ...
    public interface ICategoriesApi
    {
        ...
        /// <returns>ApiListResponseOfCategory</returns>
        ApiListResponseOfCategory GetCategoriesUsingGET (string country, string xYapilyApiVersion);
    }
    ...
    public class CategoriesApi : ICategoriesApi
    {
        ...
        /// <param name="xYapilyApiVersion">__Optional__. Determines the API version to use. Valid values are &#x60;1.0&#x60; or &#x60;2.0-ALPHA&#x60;. Defaults to &#x60;1.0&#x60;</param>
        /// <returns>ApiListResponseOfCategory</returns>
        public ApiListResponseOfCategory GetCategoriesUsingGET (string country, string xYapilyApiVersion)
        {
            // verify the required parameter 'country' is set
            if (country == null) throw new ApiException(400, "Missing required parameter 'country' when calling GetCategoriesUsingGET");
    
            var path = "/categories/{country}";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "country" + "}", ApiClient.ParameterToString(country));
            ...
            return (ApiListResponseOfCategory) ApiClient.Deserialize(response.Content, typeof(ApiListResponseOfCategory), response.Headers);
        }
