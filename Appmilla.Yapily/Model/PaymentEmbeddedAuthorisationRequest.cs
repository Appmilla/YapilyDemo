...
namespace Appmilla.Yapily.Model {
  ...
  public class PaymentEmbeddedAuthorisationRequest {
    ...
    /// <summary>
    /// Gets or Sets TotalMaxAmount
    /// </summary>
    [DataMember(Name="totalMaxAmount", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "totalMaxAmount")]
    public decimal? TotalMaxAmount { get; set; }

    /// <summary>
    /// Gets or Sets TotalMaxAmountFrequency
    /// </summary>
    [DataMember(Name="totalMaxAmountFrequency", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "totalMaxAmountFrequency")]
    public string TotalMaxAmountFrequency { get; set; }

    /// <summary>
    /// Gets or Sets MaxAmountPerRequest
    /// </summary>
    [DataMember(Name="maxAmountPerRequest", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "maxAmountPerRequest")]
    ...
    /// <summary>
    /// Gets or Sets AllowOverdraft
    /// </summary>
    [DataMember(Name="allowOverdraft", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "allowOverdraft")]
    ...
    public override string ToString()  {
      ...
      sb.Append("  TotalMaxAmount: ").Append(TotalMaxAmount).Append("\n");
      sb.Append("  TotalMaxAmountFrequency: ").Append(TotalMaxAmountFrequency).Append("\n");
      sb.Append("  MaxAmountPerRequest: ").Append(MaxAmountPerRequest).Append("\n");
