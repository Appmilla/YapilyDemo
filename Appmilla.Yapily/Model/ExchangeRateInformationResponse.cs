...
namespace Appmilla.Yapily.Model {
  ...
  public class ExchangeRateInformationResponse {
    /// <summary>
    /// Gets or Sets ExchangeRateExpiryDate
    /// </summary>
    [DataMember(Name="exchangeRateExpiryDate", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "exchangeRateExpiryDate")]
    public DateTime? ExchangeRateExpiryDate { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  ExchangeRateExpiryDate: ").Append(ExchangeRateExpiryDate).Append("\n");
